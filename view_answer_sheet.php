...
<?php	echo '<form id="user_form" novalidate action="exam_processor.php?q=addtheoryans&eid='.$exam_id.'&n='.$no_of_questions.'&examiner_id='.$examiner_id.'&regno='.$regno.'&name='.$name.'&class_id='.$class_id.'&subject_id='.$subject_id.'"  method="post">';
...
?>
						...
						?>
									...
									<div class="form-group"> 
										<img id = "output" src="<?php if(@validate($s_ansimg)){echo $s_ansimg;} ?>" class = "<?php if(!@validate($s_ansimg)){echo "hide";} ?>" />
									</div>
									...
									<div class="form-group"> 
										<img id = "output" src="<?php if(@validate($m_ansimg)){echo $m_ansimg;} ?>" class = "<?php if(!@validate($m_ansimg)){echo "hide";} ?>"  />
									</div>
