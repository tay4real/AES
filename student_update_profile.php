...
<div class="row" style="background-color:#fff; padding-top:30px; padding-bottom:30px">
 ...
 <form class="form-horizontal title1" name="form" action="update_student.php"  method="POST" enctype="multipart/form-data">
<div class="w3-row w3-padding">
                            
                           <span class="title1" style="margin-left:30%;font-size:30px;"><center><img src="image/profile_update.png" /></center></span><br /><br />
                         <h4>
					<?php
