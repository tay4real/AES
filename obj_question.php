...
<title>OSAES || ADMIN DASHBOARD</title>
...
<div class="row">
<div class="col-lg-8">
<span class="logo">Ondo State Automated Examination System</span></div>
<?php
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash_admin.php?q=0"><b>Examiner Dashboard</b></a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown <?php if(@$_GET['q']==9 || @$_GET['q']==10 || @$_GET['q']==11 || @$_GET['q']==12) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash_admin.php?q=9">Create Theory Exam</a></li>
             <li><a href="dash_admin.php?q=10">View Theory Exams</a></li>
             <li><a href="dash_admin.php?q=11">Create Objective Exam</a></li>
            <li><a href="dash_admin.php?q=12">View Objective Exams</a></li>
            <li><a href="dash_admin.php?q=13">Print Answered Booklets</a></li>
        ...
        <li class="dropdown <?php if(@$_GET['q']==13 || @$_GET['q']==14) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash_admin.php?q=13">Input Results</a></li>
            <li><a href="dash_admin.php?q=14">View all Results</a></li>
...
<select id="ans'.$i.'" name="ans'.$i.'" placeholder="Choose correct answer " class="form-control input-md" >
  ...
  <b>Upload Question (for image-base question only)&nbsp;'.$i.'&nbsp;:</><br /><!-- Text input-->
<div class="form-group">
  <label class="col-md-12 control-label" for="qns'.$i.' "></label>  
  <div class="col-md-12">
  <input type = "file" name="qns1'.$i.'" class="form-control" placeholder="Write question number '.$i.' here...">  
  </div>
</div>'; 
