...
<span class="title1" style="font-size:30px;"><center><img src="image/theory_detail.png" /></center></span><br />
 <div class="col-md-3"></div>
 <div class="col-md-6">
<form class="form-horizontal" name="form" action="choose_exam.php?q=theory_exam" onSubmit="return validateForm()" method="POST" enctype="multipart/form-data">
                                <fieldset>
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="total_questions" name="total_questions" placeholder="Set Total number of questions" class="form-control input-md" type="number" />
									...
									<div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input id="time_limit" name="time_limit" placeholder="Set time limit for the examination in minutes"   class="form-control input-md" type="number" />
