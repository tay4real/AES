...
<form class="form-horizontal" name="form" action="dash_student.php?q=20" method="POST" enctype="multipart/form-data">
   <div class="w3-row w3-padding">

<span class="title1" style="margin-left:35%;font-size:30px;"><center><img src="image/theory_result_stu.png" /></center></span><br /><br />
                         <h4>
					<?php
