...
<span class="title1" style="margin-left:40%;font-size:30px;"><b>Student Registration</b></span><br /><br />
...
<form class="form-horizontal" name="form" action="student_reg.php" onSubmit="return validateForm()" method="POST" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                     ...
                                     <!-- Text input-->
                                    <div class="form-group">
                                        <label class="col-md-12 control-label" id="dob" for="dob"></label>  
                                        <div class="col-md-12">
                                            <input id="dob" name="dob" placeholder="Select your date of birth" class="form-control input-md tcal" type="text" />
