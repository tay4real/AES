...
$e=$_GET['e'];
$Exam_code=getTheoryExam_code($_GET['e']);
...
<font size="+2">
You are about to write THEORY exam for <b>
<?php 
...
echo '
<td> <a title="Start Exam" href="dash_student.php?q=18&step=3&eid='.$exam_id.'&n='.$no_of_questions.'&t='.$exam_time.'"><b> <button type="submit" class="btn btn-primary" name = "exam_start">Start Exam</button></b></a> </td>
';
?>
