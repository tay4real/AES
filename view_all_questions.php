...
<div class="row" style="background-color:#fff; padding-top:30px; padding-bottom:30px">
	<span class="title1" style="font-size:30px;"><center><img src="image/view_questions.png" /></center></span><br/>
 	<div class="col-md-3"></div>
 	<div class="col-md-6">
 		<form class="form-horizontal title1" name="form" action="choose_exam.php?q=view_question"  method="POST" enctype="multipart/form-data">
			<fieldset>
				<!-- Text input-->
