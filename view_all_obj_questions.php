...
<input name="name" placeholder="Search Examiner/Subjects" type="text" id="name" size="150" onkeyup="doSearch()">
  <div id="result">
  	<?php
		...
		<span class="title1" style="font-size:30px;"><center><img src="image/view_obj_qtn.png" /></center></span><br /><br />
		...
		while($row=$allObj_Questions->fetch_array() ) {
			...
			echo '<tr><td>'.$c++.'</td><td>'.$school_code.'</td><td><a href="dash_admin.php?q=17&step=3&eid='.$exam_id.'&n='.$no_of_questions.'">'.$exam_code.'</a></td><td>'.$exam_name.'</td><td>'.$class.'</td><td>'.$no_of_questions.'</td><td><a href = "dash_admin.php?q=19&e='.$examiner_id.'">'.$fullname.'</a></td><td>'.$date_performed.'</td>
			
			<td><center><a title="Delete OBJ Question" onclick="return verifyDelete()" href="update.php?del_obj_question='.$exam_id.'"><b><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></b></a></center> </td>
			
			<td> <center><a title="View/Update OBJ Question" href="dash_admin.php?q=17&step=3&eid='.$exam_id.'&n='.$no_of_questions.'"><b><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></b></a></center> </td>
