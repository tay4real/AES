        ...
        <li class="dropdown <?php if(@$_GET['q']==9 || @$_GET['q']==10) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash_admin.php?q=9">Exam Setup</a></li>
             <li><a href="dash_admin.php?q=10">View Set OBJ Questions</a></li>
             <li><a href="dash_admin.php?q=25">View Set Theory Questions</a></li>
                      
          </ul>
        </li>
        
        <li class="dropdown <?php if(@$_GET['q']==11 || @$_GET['q']==12 || @$_GET['q']==13) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash_admin.php?q=31">Objectives</a></li>
			<li><a href="dash_admin.php?q=32">Theory</a></li>
            <li><a href="dash_admin.php?q=33">Aggregate Result</a></li>
          </ul>
        </li>
...
<!--View/Edit Questions-->
<?php if(@$_GET['q']==31) {
	include_once 'admin_check_obj_exam.php';
}
?>

<!--View/Edit Questions-->
<?php if(@$_GET['q']==32) {
	include_once 'admin_check_theory_exam.php';
}
?>
