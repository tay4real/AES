...
<div class="col-lg-6">
<span class="logo">DROP YOUR FEEDBACK/COMMENTS</span></div>
<div class="col-md-2">
</div>
<div class="col-md-4">
<?php
  ...
  <div class="modal-dialog">
    <div class="modal-content title1">
      ...
      <div class="modal-body">
        <form class="form-horizontal" action="studentlogin.php?q=index.php" method="POST">
<fieldset>


<!-- Text input-->
<div class="form-group">
  <label class="col-md-3 control-label" for="regno"></label>  
  <div class="col-md-6">
...
<div class="col-md-10">
<a href="mailto:dedekinc@gmail.com" style="color:#000000">dedekinc@gmail.com</a><br /><br />
...
<div class="row">
<div class="col-md-3"><b>Registration No./ID:</b></div>
<div class="col-md-9">
<!-- Text input-->
<div class="form-group">
  <input id="regno" name="regno" placeholder="Enter your regno-id" class="form-control input-md" type="regno">    
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="Deji Adebayo" class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="#" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Deji Adex</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+234 8068945524</h4>
		<h4 style="font-family:'typo' ">dedekinc@gmail.com</h4>
		<h4 style="font-family:'typo' ">Software Dept., Ondo State Information Technology Agency (SITA)</h4></div></div>
		</p>
      </div>
...
<div class="col-md-3"></div>
<div class="col-md-6">
<form role="form" method="post" action="admin_login.php?q=index.php">
<div class="form-group">
