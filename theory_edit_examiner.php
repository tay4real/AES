...
<br/>
				...
				<div class="alert alert-success hide"></div>	
					<?php	echo '<form id="user_form" novalidate action="theory_edit_process.php?q=edit_theory_qns&n='.@$_GET['n'].'&eid='.@$_GET['eid'].'"  method="post" enctype="multipart/form-data">';?>
					<?php
						$exam_id=@$_GET['eid'];
